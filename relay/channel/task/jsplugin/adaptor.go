...
// DoResponse preserves the legacy direct-adaptor API used by channel tests.
// The task lifecycle itself calls ParseResponse and presents the response
// only after persistence and billing settlement.
